...
namespace WorkingGood.Infrastructure.Persistance.Repositories
{
    ...
    {
        public ApplicationRepository(ILogger<BaseRepository<Application>> logger, IMongoDbContext mongoDbContext, MongoDbConfig mongoDbConfig) : base(logger, mongoDbContext, mongoDbConfig)
        {
        }
    }
}
